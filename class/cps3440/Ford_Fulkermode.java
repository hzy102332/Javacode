package cps3440;
	...
	{  
	    ...
	    public Ford_Fulkermode( int[][] capacity, int nodes )  
	    {  
...
//	                break;
	    ...
	    {  
	        ...
	        Ford_Fulkermode maxFlow = new Ford_Fulkermode( capacity, nodes );  
	        long start = System.nanoTime();
	        int out = maxFlow.maxFlow( 0, nodes - 1 );
